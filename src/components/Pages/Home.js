    ...
    <>
      ...
      <div className="flex">
        ...
        <div className='text-center w-1/2 pr-6'>
          ...
          <h1 className='text-white font-sm mb-6 text-l cursor-pointer mx-48 bg-black px-3 py-2 rounded-sm hover:bg-pink-600' onClick={Drop}>Select a method to Enter Data &nbsp;&nbsp; <IoIosArrowDropdown style={{alignItems: 'center' , display:'inline-flex'}} size={24}/></h1>
          {Dropdown && (
          <div className='flex justify-center'>
            ...
            <button onClick={addcsv} className='bg-pink-600 px-3 py-2 mx-5 mb-5 text-gray-100 rounded-sm hover:bg-black'>Upload Excel</button>
          </div>
          )}
