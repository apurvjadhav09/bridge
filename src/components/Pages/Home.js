    ...
    <>
      ...
      <div className="flex">
        ...
        <div className='text-center w-1/2 pr-6'>
          ...
          <h1 className='text-white font-sm mb-6 text-l cursor-pointer mx-56 bg-black px-3 py-2 rounded-sm hover:bg-pink-600' onClick={Drop}>Select a method to Enter Data &nbsp;&nbsp; <IoIosArrowDropdown style={{alignItems: 'center' , display:'inline-flex'}} size={24}/></h1>
          {Dropdown && (
